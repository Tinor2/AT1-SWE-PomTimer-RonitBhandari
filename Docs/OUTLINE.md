...
### Phase 1 – Base Setup
- [x] Initialize Flask app (app.py, __init__.py, db.py)
- [x] Create schema.sql with lists + tasks tables
- [x] Run `flask init-db` to initialize database
...
- [x] Set up the directory and schema.sql
- [x] Configure Flask and db.py
